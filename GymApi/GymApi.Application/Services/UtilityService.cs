...
namespace GymApi.Application.Services
{
    public class UtilityService : IUtilityService
    {
        ...
        {
            string nombre_codigo = Guid.NewGuid().ToString("N").Substring(0, 11);
            ...
            {
                throw new TaskCanceledException($"Para tu Imagen solo puedes subir archivos .png, .jpg, .jpeg o .gif");
            }
