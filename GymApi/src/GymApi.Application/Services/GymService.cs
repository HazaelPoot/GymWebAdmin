...
namespace GymApi.Application.Services
{
    public class GymService : IGymService
    {
        ...
        public GymService(IGenericSqlRepository<Gimnasio> repository, IFirebaseService firebaseService, IUtilityService utilityService, ICorreoService correoService)
        {
        ...
        public async Task<Gimnasio> Crear(Gimnasio entidad, Stream Foto = null, string carpetaDestino = "", string nombreFoto = "")
        {
            ...
            try
            {
                ...
                await _correoService.RegisterGymEmail(gymCreado);
