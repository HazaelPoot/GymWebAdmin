...
namespace GymApi.Presentation.Controllers
{
    ...
    public class ServicioController : ControllerBase
    {
        ...
        {
            GenericResponse<DtoServicio> gResponse = new();
        ...
        public async Task<IActionResult> Crear(int id, [FromForm] IFormFile foto, [FromForm] string modelo)
        {
            ...
            try
            {
                ...
                DtoServicio servicioCreado = _mapper.Map<DtoServicio>(await _servicioService.Crear(id, _mapper.Map<Servicio>(dtoServicio), fotoStream, "Gym_Servicios", nombreFoto));
                dtoServicio = servicioCreado;

                gResponse.Status = true;
                gResponse.Message = "El servicio se ha agregado correctamente";
                gResponse.Object = dtoServicio;
        ...
        public async Task<IActionResult> Editar([FromForm] IFormFile foto, [FromForm] string modelo)
        {
            ...
            try
            {
                ...
                DtoServicio servicioEditado = _mapper.Map<DtoServicio>(await _servicioService.Editar(_mapper.Map<Servicio>(dtoServicio), fotoStream, "Gym_Servicios", nombreFoto));
                dtoServicio = servicioEditado;
