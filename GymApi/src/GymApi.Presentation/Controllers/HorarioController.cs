...
namespace GymApi.Presentation.Controllers
{
    ...
    public class HorarioController : ControllerBase
    {
        ...
        {
            GenericResponse<DtoHorario> gResponse = new();
        ...
        public async Task<IActionResult> Crear(int id, [FromForm] string modelo)
        {
            ...
            try
            {
                ...
                DtoHorario horarioCreado = _mapper.Map<DtoHorario>(await _horarioService.Crear(id, _mapper.Map<Horario>(dtoHorario)));
                dtoHorario = horarioCreado;
        ...
        public async Task<IActionResult> Editar([FromForm] string modelo)
        {
            ...
            try
            {
                ...
                DtoHorario horarioEditado = _mapper.Map<DtoHorario>(await _horarioService.Editar(_mapper.Map<Horario>(dtoHorario)));
                dtoHorario = horarioEditado;
